...
import pages.Page;
// CREATES AND SHOWS NEW FUNCTIONAL REQUIREMENTS PAGE || INPUTS FOR NEW REQUIREMENTS
public class NewFuncReqPage extends Page {
    ...
    protected void setHandlers() {
        done.setOnAction(RequirementsController.addNewRequirements(stage,definitionInput,generalBox,true));
        returnButton.setOnAction(RequirementsController.OpenFuncRequirements(stage));
    }
}
